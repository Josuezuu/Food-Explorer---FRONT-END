...
export function Menu() {
  ...
  function viewDetails(dishId) {
    navigate(`/detalhe-do-produto/${dishId}`);
  }
  ...
  return (
    <Container>
      <header>
        <ButtonText icon={FiX} onClick={handleClickBack} />
        <h2>Menu</h2>
      </header>
      ...
      <Content>
        ...
        {search.length > 0 ? (
          <ul>
            <li>
              {dishes.map((dish) => (
                <a key={dish.id} onClick={() => viewDetails(dish.id)}>
                  <img
                    src={image[dish.id]}
          ...
          <>
            <Section>
              <ButtonText onClick={handleClickNewDish} title="Novo prato" />
            </Section>
            ...
            <Section>
              <ButtonText onClick={handleClickBack} title="Sair" />
            </Section>
          </>
        )}
      </Content>
